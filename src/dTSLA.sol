...
contract dTSLA is FunctionsClient , ConfirmedOwner , ERC20{
    ...
    /*//////////////////////////////////////////////////////////////
                               CONSTRUCTOR
    //////////////////////////////////////////////////////////////*/
    constructor(uint64 subscriptionId, address router) FunctionsClient(router) ConfirmedOwner(msg.sender) ERC20("dTSLA", "dTSLA"){
    ...
    function getCalculatedNewTokenValue(uint256 amountOfTokenToMint) internal view returns(uint256){
